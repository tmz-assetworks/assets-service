...
public class GetDispenserByChargeBoxIdHandler : IRequestHandler<GetDispenserByChargeBoxIdQuery, AssetsService.Core.Entities.Dispenser>
    {
        ...
        public async Task<AssetsService.Core.Entities.Dispenser> Handle(GetDispenserByChargeBoxIdQuery request, CancellationToken cancellationToken)
        {
