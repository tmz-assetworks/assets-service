...
11. docker image build -t &lt;docker_container _registory&gt;/Asset_api:M4-release .
12. docker push &lt;docker_container _registory&gt;/Asset_api:M4-release
13. run this command on server cmd - &quot;docker run -d --name assetapi -p 5003:80
    &lt;docker_container _registory&gt;/Asset_api:M4-release&quot;
